...
if rad == "UFO Dataset":
    ...
    @st.cache
    def load_data(nrows):
        ufo=pd.read_csv(r"C:\Users\admin\Desktop\AUB\MSBA 325-Data Visualization\Plotly\ufo_clean.csv", nrows=nrows)
        return ufo
...
if rad == "Cameras Dataset":
    ...
    def load_data2(nrows):
        camera=pd.read_csv(r"C:\Users\admin\Desktop\AUB\MSBA 325-Data Visualization\Plotly\camera.csv")
